...
function App() {
  ...
  useEffect(() => {
    ...
    async function getTasks() {
      fetch("http://localhost:9000/plannedTasks/index", signal)
        .then((res) => res.json())
        .then((data) => {
      ...
      fetch("http://localhost:9000/progressTasks/index", signal)
        .then((res) => res.json())
        .then((data) => {
      ...
      fetch("http://localhost:9000/completedTasks/index", signal)
        .then((res) => res.json())
        .then((data) => {
  ...
  function handleTaskAdd(task) {
    ...
    fetch("http://localhost:9000/plannedTasks/add", opts)
  ...
  function handleTaskProgress(task, section) {
    ...
    fetch("http://localhost:9000/progressTasks/add", opts)
      .then((response) => response.json())
      .then((data) => {
    ...
    fetch(`http://localhost:9000/plannedTasks/${task._id}`, {
      method: "DELETE",
    });
  ...
  function handleTaskCompleted(task) {
    ...
    fetch("http://localhost:9000/completedTasks/add", opts)
      .then((response) => response.json())
      .then((data) => {
    ...
    fetch(`http://localhost:9000/progressTasks/${task._id}`, {
      method: "DELETE",
    });
  }
  ...
  async function handlePlannedTaskUpdate(id, text) {
    ...
    await fetch(`http://localhost:9000/plannedTasks/${id}`, opts);

    fetch("http://localhost:9000/plannedTasks/index", {
      method: "GET",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  async function handleProgressTaskUpdate(id, text) {
    ...
    await fetch(`http://localhost:9000/progressTasks/${id}`, opts);

    fetch("http://localhost:9000/progressTasks/index", {
      method: "GET",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  async function handleCompletedTaskDelete(task) {
    ...
    fetch(`http://localhost:9000/completedTasks/${task._id}`, {
      method: "DELETE",
    });
  }

  async function handleClearAll() {
    fetch(`http://localhost:9000/tasks`, { method: "DELETE" })
      .then((res) => res.text())
      .then((data) => {
